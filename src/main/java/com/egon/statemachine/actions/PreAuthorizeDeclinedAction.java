...
@Slf4j
@Component
public class PreAuthorizeDeclinedAction implements Action<PaymentStateEnum, PaymentEventEnum> {
  @Override
  public void execute(StateContext<PaymentStateEnum, PaymentEventEnum> stateContext) {
    ...
    log.debug("Pre-authorize declined action for payment {}", paymentId);
  }
}
