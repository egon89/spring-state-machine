...
@Slf4j
@Component
public class AuthorizationApprovedAction implements Action<PaymentStateEnum, PaymentEventEnum> {
  @Override
  public void execute(StateContext<PaymentStateEnum, PaymentEventEnum> stateContext) {
    ...
    log.debug("Authorization approved action for payment {}", paymentId);
  }
}
